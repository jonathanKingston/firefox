...
------boundary------`;
  ...
  Assert.ok(
    parts[0].contentType.includes("text/html"),
    "Content type should be HTML"
  );
  Assert.equal(
    parts[0].contentLocation,
    "http://example.com/test.html",
    "Location should match"
  );
  Assert.ok(
    parts[0].body.includes("<h1>Test</h1>"),
...
------boundary------`;
  ...
  Assert.ok(
    decoded.includes("Plain ASCII"),
    "7-bit content should decode correctly"
  );
});
...
------boundary------`;
  ...
  Assert.ok(
    decoded.includes("Testing Quoted-Printable"),
    "Should decode =20 as space"
  );
...
------boundary------`;
  ...
  Assert.ok(
    decoded.includes("No encoding header"),
    "Should handle missing encoding"
  );
});
...
<html><body>Missing closing boundary</body></html>`;
  ...
  Assert.greaterOrEqual(
    parts.length,
    0,
    "Parser should handle missing boundary gracefully"
  );
...
------boundary------`;
  ...
  Assert.ok(
    parts[0].body.includes("Relaxed parsing"),
...
------=_NextPart_000_0000--`;
  ...
  Assert.ok(
    parts[0].body.includes("Different boundary"),
    "Content should be extracted"
  );
});
...
------MultipartBoundary--`;
  ...
  Assert.equal(
    parts[1].contentID,
    "css-123@mhtml.blink",
    "Content-ID should match without angle brackets"
  );
