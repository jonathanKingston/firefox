...
------boundary------`;
  ...
  Assert.equal(
    mainDoc.contentType,
    "text/html",
    "Main document should be HTML"
  );
  Assert.ok(
    mainDoc.body.includes("Main Document"),
...
------boundary------`;
  ...
  Assert.ok(
    urls.includes("http://example.com/page.html"),
    "Should include HTML"
  );
  Assert.ok(
    urls.includes("http://example.com/style.css"),
    "Should include CSS"
  );
  Assert.ok(
    urls.includes("http://example.com/image.png"),
