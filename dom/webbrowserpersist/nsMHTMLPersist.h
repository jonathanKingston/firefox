...
#ifndef nsMHTMLPersist_h_
#define nsMHTMLPersist_h_
...
class MHTMLPersist {
 public:
  ...
  // Override the Date header value for deterministic test output.
  void SetDateOverrideForTesting(const nsACString& aDate) {
    mDateOverride = aDate;
  }
 ...
 private:
  ...
  static nsCString GenerateBoundary();
  static nsresult GetURLSpec(nsIURI* aURI, nsACString& aSpec);

  nsCOMPtr<nsIOutputStream> mStream;
  nsCString mBoundary;
  nsCOMPtr<nsIURI> mMainDocumentURI;
  nsCString mDateOverride;
};
